...
public class MapMaker extends javax.swing.JFrame {
        ...
        mapPanel = new javax.swing.JPanel(){
            public void paintComponent(Graphics g){
                ...
                if(file!=null||spritesheet!=null||map!=null){
                    ...
                    g.drawImage(spritesheet.getSubimage(gridSize*(map.get(r,c)%(spritesheet.getWidth()/gridSize)), gridSize*(map.get(r,c)/(spritesheet.getWidth()/gridSize)), gridSize,gridSize),c*gridSize,r*gridSize,null);
    ...
    private void spriteScrollPaneMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_spriteScrollPaneMousePressed

    }//GEN-LAST:event_spriteScrollPaneMousePressed

    private void spriteSheetPanelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_spriteSheetPanelMousePressed
    ...
    }//GEN-LAST:event_spriteSheetPanelMousePressed

    private void mapPanelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mapPanelMousePressed
        if(selectedTile!=null){
            map.set((evt.getY()/gridSize),(evt.getX()/gridSize),(selectedTileY/gridSize)*(spritesheet.getWidth()/gridSize)+(selectedTileX/gridSize)); 
